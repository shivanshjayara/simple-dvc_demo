...
from get_data import read_params # just to read the yaml file
...
# all these are required form configuration file
...
if __name__ == "__main__":
    ...
    #Now we have to define this stage also refere to stage-2